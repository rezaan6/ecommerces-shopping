...
<main>
    <div class="click-out" onclick="searchout()">
            ...
            <div class="sign" >
            <form method="post" action="../../../pages/women/accessories/watch.php">
    <div class="sign-left">
         <h1>SIGN IN</h1>
         <h3>Email</h3>
...
<div class="tab">
            <a href=""> <button class="tablinks" onclick="openCity(event, 'new-arrival')">Watches</button></a>
...
?>
  ...
  ?>
    <?php if($category==2 && $loop<=8 && $subcategory==32){
   ?>
   <?php    
                           $image= "../../../$image";
