...
<main>
    <div class="click-out" onclick="searchout()">
            ...
            <div class="sign" >
    <form method="post" action="../../../pages/women/footwear/sneaker.php">
    <div class="sign-left">
         <h1>SIGN IN</h1>
         <h3>Email</h3>
...
<div class="tab">
            <a href=""> <button class="tablinks" onclick="openCity(event, 'new-arrival')">Sneaker</button></a>
...
?>
  ...
  ?>
    <?php if($category==2 && $loop<=8 && $subcategory==35){
   ?>
   <?php    
                           $image= "../../../$image";
