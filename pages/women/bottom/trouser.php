...
<main>
    <div class="click-out" onclick="searchout()">
            ...
            <div class="sign" >
    <form method="post" action="../../../pages/women/bottom/trouser.php">
    <div class="sign-left">
         <h1>SIGN IN</h1>
         <h3>Email</h3>
...
<div class="tab">
            <a href=""> <button class="tablinks" onclick="openCity(event, 'new-arrival')">Trouser</button></a>
...
?>
  ...
  ?>
    <?php if($category==2 && $loop<=8 && $subcategory==27){
   ?>
