    ...
    <div class="click-out" onclick="searchout()">
            ...
            <div class="sign" >
    <form method="post" action=" ../pages/women.php">
    <div class="sign-left">
         <h1>SIGN IN</h1>
         <h3>Email</h3>
 ...
 <div class="profile-bottom">
     ...
     <button type="submit" name="logout" id="prof-logout" >LOGOUT</button>
        ...
        <div class="men-option"  style="height:750px;">
          <div class="men-top">
              <img id="women-top" src="../images/top-w.jpg" alt="">
             <a href="../pages/women/top.php" style="text-decoration: none;"><h2 >TOP</h2></a> 
           <h3>Shirt, T-Shirt, Jacket, Coat</h3>
          </div>
          <div class="men-bottom">
            <img id="women-bottom" src="../images/bottom-w.jpg" alt="">

            <a href="../pages/women/bottom.php" style="text-decoration: none;"><h2>BOTTOM</h2></a>

            <h3>Jean, Sweatpant, Trouser, Skirt</h3>
          

          </div>
          <div class="men-accessories">
            <img id="women-accessories" src="../images/accessories-w.jpg" alt="">

            <a href="../pages/women/accessories.php" style="text-decoration: none;"><h2>ACCESSORIES</h2></a>

            <h3>Cap, Sunglass, Handbag, Watch, Belt</h3>
         

          </div>
          <div class="men-footwear">
            <img id="women-footwear" src="../images/footwear-w.jpg" alt="">

            <a href="../pages/women/footwear.php" style="text-decoration: none;"><h2>FOOTWEAR</h2></a>

            <h3>High Heel, Sneaker, Scandal, Sock</h3>
          </div>
